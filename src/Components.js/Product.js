                        ...
                        <div className="ec-pro-variation-content">
                          ...
                          {storagelist ?
                            storagelist.map((itm,k)=>(
                              ...
                              <li key={k} className="classheadstyle"  style={istorage === itm ?{backgroundColor:"#00a279",color:"#ffffff"}:{}} onClick={()=>setistorage(itm) &seticondition('') &setiprice('') & setogprice('')}><span >{itm}</span></li>
                            ))
                          :null}
                          </ul>
                        </div>
                        ...
                        <div className="ec-pro-variation-content">
                          ...
                          {productdetail ? <>
                            {(productdetail[0].sellprice.split(',')).filter(name => name.includes(istorage)).map((itm,i) =>(
                              <li key={i} className='price p-2 classchildstyle '  style={icondition === itm.split('-')[1] ?{backgroundColor:"#00a279",color:"#ffffff",height:"60px",width:"130px"}:{height:"60px",width:"130px"}} onClick={()=>seticondition(itm.split('-')[1]) & setiprice(itm.split('-')[2]) &setogprice(itm.split('-')[2])}><span className='text-capitalize '><span className='fw-bold' >{itm.split("-")[1]}</span><br/> AED {itm.split('-')[2]}</span></li>
